...
public class ProjectEntity
{
    ...
    // ReSharper disable once EntityFramework.ModelValidation.UnlimitedStringLength
    public string? PullRequestReviewInstructions { get; set; }

    // ReSharper disable once EntityFramework.ModelValidation.UnlimitedStringLength
    public string? CSharpXmlSummaryInstructions { get; set; }

    public bool ChatUseSourceCodeSearch { get; set; } = true;

    public bool ChatUseDocumentationSearch { get; set; } = true;

    public int ChatMaxNumberOfAnswersBackFromSourceCodeSearch { get; set; } = 10;

    public double ChatScoreShouldBeLowerThanThisInSourceCodeSearch { get; set; } = 0.5;

    public int ChatMaxNumberOfAnswersBackFromDocumentationSearch { get; set; } = 10;

    public double ChatScoreShouldBeLowerThanThisInDocumentSearch { get; set; } = 0.5;

    public bool XmlSummariesUseSourceCodeSearch { get; set; } = true;

    public bool XmlSummariesUseDocumentationSearch { get; set; } = true;

    public int XmlSummariesMaxNumberOfAnswersBackFromSourceCodeSearch { get; set; } = 10;

    public double XmlSummariesScoreShouldBeLowerThanThisInSourceCodeSearch { get; set; } = 0.5;

    public int XmlSummariesMaxNumberOfAnswersBackFromDocumentationSearch { get; set; } = 10;

    public double XmlSummariesScoreShouldBeLowerThanThisInDocumentSearch { get; set; } = 0.5;

    public bool PrReviewUseSourceCodeSearch { get; set; } = true;

    public bool PrReviewUseDocumentationSearch { get; set; } = true;

    public int PrReviewMaxNumberOfAnswersBackFromSourceCodeSearch { get; set; } = 10;

    public double PrReviewScoreShouldBeLowerThanThisInSourceCodeSearch { get; set; } = 0.5;

    public int PrReviewMaxNumberOfAnswersBackFromDocumentationSearch { get; set; } = 10;

    public double PrReviewScoreShouldBeLowerThanThisInDocumentSearch { get; set; } = 0.5;
    ...
    public static ProjectEntity Empty()
    {
        return new ProjectEntity
        {
            ...
            Name = string.Empty,
            Sources = [],
            ChatInstructions = GenerateChatInstructions(),
            ...
            CSharpXmlSummaryInstructions = GenerateCSharpXmlSummaryInstructions(),
            ...
            PullRequestReviewInstructions = GeneratePullRequestReviewInstructions(),
